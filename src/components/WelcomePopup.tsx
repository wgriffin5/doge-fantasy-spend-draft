...
export default function WelcomePopup() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="fixed left-[50%] top-[50%] z-[100] w-[calc(100%-2rem)] max-w-md -translate-x-[50%] -translate-y-[50%] rounded-lg bg-background p-6 shadow-xl md:w-full">
        <DialogHeader>
